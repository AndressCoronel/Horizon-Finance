...
import { useDemoPortfolio, useDemoDolarBlue } from "@/hooks/use-demo-queries";
...
export default function DemoDashboardPage() {
    const { data: portfolio, isLoading: portfolioLoading } = useDemoPortfolio();
    const { data: dolar, isLoading: dolarLoading } = useDemoDolarBlue();
